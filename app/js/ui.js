...
const I={
  ...
  candado:s('<rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2.4"/><path d="M8.2 10.4V7.8a3.8 3.8 0 0 1 7.6 0v2.6"/>'),
  abierto:s('<rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2.4"/><path d="M8.2 10.4V7.8a3.8 3.8 0 0 1 7.3-1.2"/>'),
  brujula:s('<circle cx="12" cy="12" r="8.6"/><path d="m15.2 8.8-1.8 4.6-4.6 1.8 1.8-4.6z" fill="currentColor" stroke="none"/>'),
