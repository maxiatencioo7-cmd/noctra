...
const CACHE="noctra-app-v6";
const ARCHIVOS=["./","./index.html","./css/app.css","../js/perfil-codigo.js","./js/astro.js","./js/datos.js","./js/lectura.js","./js/ui.js","./js/maia.js","./js/preguntas.js","./js/retratos.js","./js/rasgos.js","./js/app.js","./manifest.webmanifest","./icons/icon.svg","./icons/icon-192.png","./icons/icon-512.png"];
